...
**Initial Liquidity Pools \(LPs\) for farming ANPAN tokens:**
...
**\*\*\[**Get your FLIP tokens \(AnpanSwap Liquidity Provider Tokens\) HERE**\]\(**[https://exchange.anpanswap.finance/\#/swap](https://exchange.anpanswap.finance/#/swap)**\)**.\*\*
