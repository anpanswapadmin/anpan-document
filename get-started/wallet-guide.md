...
![](img-wallet-2021-09-06-23-20-09.png)

To get started on AnpanSwap, the first thing you'll need is to set up a wallet that supports Binance Smart Chain \(BSC\). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with AnpanSwap.
...
* Additional steps needed to use with Binance Smart Chain and AnpanSwap  
...
To connect to Binance Smart Chain and use AnpanSwap, you can follow the TokenPocket section of our [Connect Your Wallet to AnpanSwap guide](https://docs.anpanswap.finance/#/get-started/connection-guide).
...
**Danger:** \*\*NEVER, in any situation, should you ever give someone your private key or recovery phrase \("seed phrase"\). This will give someone complete access to your crypto! The genuine AnpanSwap site and staff will never ask you to input your seed phrase.\*\*
...
This comparison table gives an overview of the most popular desktop wallets used with AnpanSwap.
...
* Supports Binance Smart Chain by default, making using AnpanSwap easy  
* Supports a large number of languages  
...
And that’s it, all done! You can follow our [Connect Your Wallet to AnpanSwap guide](https://docs.anpanswap.finance/#/get-started/connection-guide) to connect to Binance Smart Chain and AnpanSwap.
