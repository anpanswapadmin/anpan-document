...
**Warning:**  
AnpanSwap is based on Uniswap v2. Read the [Uniswap v2 documentation](https://uniswap.org/docs/v2/).  
...
**Contract name:** AnpansRouter  
**Contract address:** 0xe8d2c4ca811e0445B83326aBe85B7c40C66759eD

View [AnpansRouter.sol on GitHub](https://github.com/anpanswap/anpan-swap-periphery/blob/master/contracts/AnpansRouter.sol).

View the [AnpanSwap: Router contract on BscScan](https://bscscan.com/address/0xe8d2c4ca811e0445B83326aBe85B7c40C66759eD#code).
...
Returns the canonical address for [AnpansFactory](https://bscscan.com/address/0xEb4D933D56E5deF7B24F543766dD398f1DaFEEd5).
...
```text
import '@uniswap/v2-core/contracts/interfaces/IAnpansRouter.sol';
```

```text
pragma solidity >=0.6.2;

interface IAnpansRouter01 {
    function factory() external pure returns (address);
    function WETH() external pure returns (address);
...
// File: contracts\interfaces\IAnpansRouter02.sol

pragma solidity >=0.6.2;

interface IAnpansRouter02 is IAnpansRouter01 {
    function removeLiquidityETHSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
