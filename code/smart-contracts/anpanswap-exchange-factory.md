...
**Contract name:** AnpansFactory  
**Contract address:** 0xEb4D933D56E5deF7B24F543766dD398f1DaFEEd5

View [AnpansFactory.sol on GitHub](https://github.com/anpanswap/anpan-swap-core/blob/master/contracts/AnpansFactory.sol).

View the [AnpanSwap: Factory contract on BscScan](https://bscscan.com/address/0xEb4D933D56E5deF7B24F543766dD398f1DaFEEd5#code).
...
```text
import '@uniswap/v2-core/contracts/interfaces/IAnpansFactory.sol';
```
